...
def route_profile(request):
    # 解析 request
    """
    method = 'GET' path = '' query = {} body = '' headers = {} cookies = {}
    :param request: 是一个类
    :return:
    """
    ...
    if username == '【游客】':
        ...
        return headers.encode(encoding='utf-8')
    else:
        ...
        u = User(form).find_by(username=username)
        log("u is what:", u.username, u.id, u.note)
